...
tags_metadata = {
    ...
    "summary": "Задание №5: Вставка данных через репозиторий",  # short summary of the API
    "version": "ver. 0.5.0",  # По умолчанию version = "0.1.0", Source code in fastapi/applications.py
