...
tags_metadata = {
    ...
    "summary": "Задание № 16: Изменение удобств номера через API",  # short summary of the API
    "version": "ver. 0.16.0",  # По умолчанию version = "0.1.0", Source code in fastapi/applications.py
