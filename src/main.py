...
tags_metadata = {
    ...
    "summary": "Задание №6: Обновление и удаление данных через репозиторий",  # short summary of the API
    "version": "ver. 0.6.0",  # По умолчанию version = "0.1.0", Source code in fastapi/applications.py
