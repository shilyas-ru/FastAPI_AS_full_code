...
15. Добавляем возможность:
    ...
    - Выборки свободных (не забронированных) номеров.
    Для этого:
    ...
    - В репозитории HotelsRepository изменен метод get_limit - добавлена возможность выбирать отели со свободными номерами.
    - В репозитории RoomsRepository изменен метод get_limit - добавлена возможность выбирать свободные номера.
    - Внесены изменения в код, позволяющие искать и удалять отели по критериям, включающим использование критериев для всех отелей/номеров или для отелей/номеров, имеющих свободные номера.
    - Сделана возможность вывода полного списка отелей/номеров и вывод отелей/номеров со свободными номерами.
